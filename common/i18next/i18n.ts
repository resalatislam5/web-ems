      ...
      pricing: {
        ...
        plans: {
          monthly: {
            ...
            features: [
              'Customize your dashboard to fit your workflow',
              'Create unlimited students with ease',
              'Manage unlimited enrollments seamlessly',
              'Generate unlimited accounts without restrictions',
              'Issue unlimited money receipts instantly',
              'Track and manage unlimited expenses',
              'Flexible custom configuration to match your business needs',
              'Advanced custom reports for students, expenses, and financial insights',
            ],
            per: '/month',
          },
          yearly: {
      ...
      pricing: {
        ...
        plans: {
          monthly: {
            ...
            discount: '৫০% ছাড়',
            discount_price: '৳৪৯৯',
            desc: 'ছোট একাডেমি বা নতুনভাবে শুরু করা প্রতিষ্ঠানের জন্য উপযুক্ত।',
            features: [
              'আপনার প্রয়োজন অনুযায়ী ড্যাশবোর্ড কাস্টমাইজ করুন',
              'অসীম সংখ্যক শিক্ষার্থী তৈরি করুন',
              'সহজে অসীম সংখ্যক এনরোলমেন্ট পরিচালনা করুন',
              'অসীম সংখ্যক অ্যাকাউন্ট তৈরি করুন',
              'তাৎক্ষণিকভাবে অসীম সংখ্যক মানি রিসিপ্ট তৈরি করুন',
              'অসীম সংখ্যক খরচ ট্র্যাক ও ম্যানেজ করুন',
              'আপনার ব্যবসার প্রয়োজন অনুযায়ী কাস্টম কনফিগারেশন',
              'শিক্ষার্থী, খরচ ও ফাইন্যান্স সম্পর্কিত কাস্টম রিপোর্ট',
            ],
          },
          yearly: {
            name: 'বার্ষিক',
            ...
            discount_price: '৳৪৯৯৯',
            discount: '৫০% ছাড়',
            freeMonths: '২ মাস ফ্রি',
            desc: 'বর্ধনশীল কোর্স প্রোভাইডার ও কনসালটেন্সির জন্য আদর্শ।',
            features: [
              'আপনার প্রয়োজন অনুযায়ী ড্যাশবোর্ড কাস্টমাইজ করুন',
              'অসীম সংখ্যক শিক্ষার্থী তৈরি করুন',
              'সহজে অসীম সংখ্যক এনরোলমেন্ট পরিচালনা করুন',
